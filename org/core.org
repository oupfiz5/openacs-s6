...
|------------------+--------------------+-------------------------------------|
| [[#postgres-tag][POSTGRES_TAG]]     | 14.1-alpine        | Postgres image tag                  |
|------------------+--------------------+-------------------------------------|
...
#+begin_src sh :shebang ""
  ...
  NS_IMAGE_REPOSITORY='oupfiz5'
  NS_IMAGE_NAME='naviserver-s6'
  NS_IMAGE_TAG='4.99.23'
  IMAGE_NAME='openacs-s6'
  IMAGE_REPOSITORY='oupfiz5'
  IMAGE_TAG="${NS_IMAGE_TAG}"

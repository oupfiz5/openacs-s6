...
:END:
 ...
 |---------------------+-----------------------+---------------------------|
 | NS_IMAGE_TAG        | 22.04-3.1.2.1-4.99.24 | Set NaviServer version    |
 |---------------------+-----------------------+---------------------------|
...
#+begin_src sh :shebang ""
  ...
  NS_IMAGE_TAG="${NS_IMAGE_TAG:-22.04-3.1.2.1-4.99.24}"

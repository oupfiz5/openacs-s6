...
:END:
 ...
 |---------------------+-----------------------+---------------------------|
 | NS_IMAGE_TAG        | 20.04-3.0.0.2-4.99.23 | Set NaviServer version    |
 |---------------------+-----------------------+---------------------------|
...
|---------------------+--------------------+-------------------------------------|
| [[*NaviServer configuration file][NS_CONF]]             | openacs-config.tcl | Full path to configuration file     |
...
#+begin_src sh :shebang ""
  ...
  IMAGE_TAG="${IMAGE_TAG:-v3-oacs-5-10}"
